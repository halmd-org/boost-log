...
BOOST_LOG_FORCEINLINE ActorT< terminal< unary_adapter< attribute_begins_with< T, typename boost::log::aux::make_embedded_string_type< SubstringT >::type, FallbackPolicyT > > > >
begins_with(attribute_actor< T, FallbackPolicyT, TagT, ActorT > const& attr, SubstringT const& substring)
{
    typedef terminal< unary_adapter< attribute_begins_with< T, typename boost::log::aux::make_embedded_string_type< SubstringT >::type, FallbackPolicyT > > > terminal_type;
...
BOOST_LOG_FORCEINLINE ActorT< terminal< unary_adapter< attribute_begins_with< typename DescriptorT::value_type, typename boost::log::aux::make_embedded_string_type< SubstringT >::type > > > >
begins_with(attribute_keyword< DescriptorT, ActorT > const&, SubstringT const& substring)
{
    typedef terminal< unary_adapter< attribute_begins_with< typename DescriptorT::value_type, typename boost::log::aux::make_embedded_string_type< SubstringT >::type > > > terminal_type;
...
BOOST_LOG_FORCEINLINE phoenix::actor< terminal< unary_adapter< attribute_begins_with< T, typename boost::log::aux::make_embedded_string_type< SubstringT >::type > > > >
begins_with(attribute_name const& name, SubstringT const& substring)
{
    typedef terminal< unary_adapter< attribute_begins_with< T, typename boost::log::aux::make_embedded_string_type< SubstringT >::type > > > terminal_type;
