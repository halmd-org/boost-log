...
#ifndef BOOST_LOG_NT_EVENTLOGSINK_HPP_INCLUDED_HPP
#define BOOST_LOG_NT_EVENTLOGSINK_HPP_INCLUDED_HPP
...
class BOOST_LOG_EXPORT nt_eventlog_sink : noncopyable,
...
typedef nt_eventlog_sink< char > eventlog_sink;
typedef nt_eventlog_sink< wchar_t > weventlog_sink ;
